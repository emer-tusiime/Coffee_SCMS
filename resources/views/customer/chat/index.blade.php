        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body chat-messages" id="messagesContainer">
                    <div v-for="message in messages" :class="[message.sender_type === 'customer' ? 'sent' : 'received']">
    ...
    const app = defineComponent({
        ...
        methods: {
            async loadMessages() {
                ...
                try {
                    const response = await axios.get(route('customer.chat.messages'), {
            ...
            async sendMessage() {
                ...
                try {
                    await axios.post(route('customer.chat.send'), {
